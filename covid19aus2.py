...
def start(update, context):
    ...
    try:
        sql = "INSERT INTO covid19aus_bot (chat_id, pilihan, galat) VALUES (%s, %s, %s)"
...
def error(update, context):
    ...
    """
    update.message.bot.send_message(chat_id=406089265, text='Thanks your data is accepted')
    update.message.chat_id
    """
    update.message.reply_text("Type /start to start/restart conversation.")
